...
class EnableStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            foreach ($ids as $id) {
                ...
                $item->setStatus(1); // Assuming 0 is the status for disabled
                $item->save();
            }
            $this->messageManager->addSuccessMessage(__('Total of %1 record(s) were enabled.', count($ids)));
        } catch (\Exception $e) {
